...
filterProducts(selectedCategory: string): void {
  this.filteredProducts = selectedCategory
   ...
   this.pageSize = this.filteredProducts.length < 10 ? this.filteredProducts.length : 10
}
...
updateFilteredProducts() {
  ...
  this.filteredProducts = this.products.slice(startIndex, startIndex + this.pageSize);
}
}
